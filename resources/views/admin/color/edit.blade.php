        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form method="post" action="{{ route('color.update',['color'=>$value->id]) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Color</label>
                     <input type="text" name="name" value="{{$value->color}}" class="form-control">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Color Code</label>
                     <input type="text" value="{{$value->color_code}}" name="color_code" class="form-control">
