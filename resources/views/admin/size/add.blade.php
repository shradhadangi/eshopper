                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($values as $v){ ?>
                          ...
                          <tr>
                              ...
                              <a style="margin: 2px;float:left;" href="{{ route('size.edit',['size'=>$v->id])}}" class="btn btn-sm btn-info"> <i class="fa fa-edit"></i> </a>
                              <form method="post" action="{{ route('size.destroy',['size'=>$v->id])}}">
                                @csrf
                                @method('DELETE')
