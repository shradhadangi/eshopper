        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form method="post" action="{{ route('product-images.update',['product_image'=>$value->id]) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('product-images.create',['id'=>$value->product_id])}}" class="btn btn-danger ">Back</a>
                  <br>
            </div>
              </form>
            </div>
