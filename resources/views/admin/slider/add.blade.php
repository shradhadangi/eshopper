                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($values as $v){ ?>
                          ...
                          <tr>
                              ...
                              <a style="margin: 2px;float:left;" href="{{ route('slider.edit',['slider'=>$v->id])}}" class="btn btn-sm btn-info"> <i class="fa fa-edit"></i> </a>
                              <form method="post" action="{{ route('slider.destroy',['slider'=>$v->id])}}">
                                @csrf
                                @method('DELETE')
