        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form method="post" action="{{ route('slider.update',['slider'=>$value->id]) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="col-md-4">
                  <img src="{{ asset('images')}}/{{$value->image}}" style="height:100px;width:100px;" alt="">
                  </div>
                </div>
