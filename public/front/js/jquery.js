        ...
        if (meanRevealPosition == "left") {
            ...
            function showMeanMenu() {
                if (currentWidth <= meanScreenWidth) {
					...
					// custome code
					jQuery('.main_menu li.item-112 > ul').remove();
					jQuery('.main_menu li.item-112').append(jQuery('.whatwedomenu-last').html());
					jQuery('.main_menu li.current.active').parent().parent().addClass('current active');		
					jQuery('.main_menu .item-112 li.current.active').parent().parent().parent().parent().addClass('current active');
                            ...
                            if(meanExpandableChildren){
                               ...
                               jQuery('.mean-expand').on("click",function(e){
                                 ...
                                 if (jQuery(this).hasClass("mean-clicked")) {
                                  ...
                                  var mainul=jQuery(this).parent().parent().children('li').children('ul');
                                  mainul.slideUp(300);
                                  var mainula=jQuery(this).parent().parent().children('li').children('a.mean-clicked');
                                  mainula.text(meanExpand);
